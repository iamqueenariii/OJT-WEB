<x-dialog-modal>
    <x-slot name="title">Add School</x-slot>

    <x-slot name="content">
        <form>
            <div class="mb-4">
                <label for="exampleFormControlInput1"
                       class="block text-gray-700 text-sm font-bold mb-2">School Name</label>
            ...
            <div class="mb-4">
                <label for="exampleFormControlInput1"
                       class="block text-gray-700 text-sm font-bold mb-2">School Head</label>

                <input type="text"
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       id="exampleFormControlInput1" placeholder="Type Here..." wire:model="school_head">
                @error('school_head') <span class="text-red-500">{{ $message }}</span>@enderror
            </div>
