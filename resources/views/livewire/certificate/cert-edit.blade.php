<x-dialog-modal wire:model="certEdit" maxWidth="lg">
    <x-slot name="title"><h2>Edit Details </h2></x-slot>
        ...
        <form>
            <div class="mb-4">
                ...
                <input type="text"
                       ...
                       id="exampleFormControlInput1" placeholder="Type Here..." wire:model.lazy="fullname">
            ...
            <div class="mb-4">
                ...
                <input type="number"
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       id="exampleFormControlInput1" placeholder="Type Here..." wire:model.lazy="hrs">
